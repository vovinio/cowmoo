...
switch (command) {
  ...
  case 'board-drags':
    ...
    break;
  default:
    console.log('Usage: node "$AGENT_DIR/tools/dev-tools.cjs" <hook|git-check|territory-check|workflow-check|next-step|detect-dev-servers|commit|push|board-status|board-drags>');
}
