...
switch (command) {
  ...
  case 'board-drags':
    ...
    break;
  default:
    console.log('Usage: node "$AGENT_DIR/tools/dev-tools.cjs" <hook|git-check|territory-check|check-files|inbox|workflow-check|next-step|clear-draft|clear-techstack-notes|commit|push|board-status|board-drags>');
}
