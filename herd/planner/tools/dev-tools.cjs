...
switch (command) {
  ...
  case 'commit':
    ...
    break;
  default:
    console.log('Usage: node tools/dev-tools.cjs <hook|git-check|territory-check|check-files|inbox|workflow-check|next-step|clear-draft|clear-techstack-notes|commit>');
}
