...
- **Do not add new findings.** You are verifying this finding, not auditing. If you notice something the finder missed, ignore it — that belongs to the next audit pass, not this verification.
